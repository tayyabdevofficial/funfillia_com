...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('home', [
            ...
            'siteTitle' => 'Funfillia - Stories, Trends & Viral Magazine',
            'siteDescription' => 'Explore the latest trending stories, lifestyle recipes, fashion, tips, and modern culture on Funfillia.',
        ]);
    }
}
