...
class BloggerApiClient
{
    ...
    public function __construct()
    {
        ...
        $this->clientDomain = (string) config('blogger.client_domain', 'funfillia.com');
    ...
    protected function generateHeaders(string $method, string $uriPath): array
    {
        ...
        if (function_exists('request') && request()) {
            ...
            $visitorDevice = request()->cookie('ff_device_id') ?? session('ff_device_id');
    ...
    public function get(string $path, array $queryParams = [], ?int $ttl = null): array
    {
        ...
        try {
            // Need the URI relative to domain or host for HMAC handshake
